...
The single thin client is the seam: add a method that calls another `/v1/...` route (e.g. one of embeddings, vector.query, ai.rerank) and reuse it from your own code.
